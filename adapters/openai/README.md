...
| new-mission | ✅ | ✅ | 純規則零依賴,「先查再問(最多五題)+計畫骨架+等明確的『做』才動手」原封搬;進階節的 ai-review 送審換成你自己的審稿工具即可。**ChatGPT 免動手:`prompts/new-mission.md` 有現成簡版,貼進 custom instructions 即用。**<br>Pure rules, zero deps — "look first, ask at most five, plan skeleton, wait for an explicit go" ports verbatim; swap the advanced section's ai-review hookup for your own reviewer. ChatGPT: paste the ready-made `prompts/new-mission.en.md` into custom instructions. |
